...
func HealSymlinks(rootDir string) error {
	...
	targets := []SymlinkTarget{
		...
		{"distributed-config/standalone.yaml", "../" + baseConfigPath},
		{"distributed-config/distconf/cpp/standalone.yaml", "../../../" + baseConfigPath},
		{"distributed-config/distconf/python/standalone.yaml", "../../../" + baseConfigPath},
		{"distributed-config/distconf/rust/standalone.yaml", "../../../" + baseConfigPath},
		{"distributed-config/src/facade/standalone.yaml", "../../../" + baseConfigPath},
		{"distributed-config/src/loader/standalone.yaml", "../../../" + baseConfigPath},
		{"flexible-logger/standalone.yaml", "../" + baseConfigPath},
		{"flexible-logger/cmd/flexible-logger/standalone.yaml", "../../../" + baseConfigPath},
		{"flexible-logger/cmd/test-log-server/standalone.yaml", "../../../" + baseConfigPath},
		{"flexible-logger/cmd/test/standalone.yaml", "../../../" + baseConfigPath},
		{"log-server/standalone.yaml", "../" + baseConfigPath},
		{"microservice-toolbox/standalone.yaml", "../" + baseConfigPath},
		{"notif-server/standalone.yaml", "../" + baseConfigPath},
		{"notif-server/cmd/notif-server/standalone.yaml", "../../../" + baseConfigPath},
		{"notif-server/src/core/standalone.yaml", "../../../" + baseConfigPath},
		{"notif-server/src/server/standalone.yaml", "../../../" + baseConfigPath},
		{"notif-server/cmd/test/standalone.yaml", "../../../" + baseConfigPath},
		{"obsidian-brain/standalone.yaml", "../" + baseConfigPath},
		{"obsidian-brain/01-Strategic-Nexus/standalone.yaml", "../../" + baseConfigPath},
		{"obsidian-brain/02-Business-BDD/standalone.yaml", "../../" + baseConfigPath},
		{"obsidian-brain/03-Tech-Stack/standalone.yaml", "../../" + baseConfigPath},
		{"obsidian-brain/04-Rapid-Prototyping/standalone.yaml", "../../" + baseConfigPath},
		{"obsidian-brain/05-Fleet-Operation/standalone.yaml", "../../" + baseConfigPath},
		{"obsidian-brain/07-Core-KMS/standalone.yaml", "../../" + baseConfigPath},
		{"obsidian-brain/08-Base-Scripts/standalone.yaml", "../../" + baseConfigPath},
		{"obsidian-brain/09-RAG-Engine/standalone.yaml", "../../" + baseConfigPath},
		{"obsidian-brain/10-Agent-Factory/standalone.yaml", "../../" + baseConfigPath},
		{"sandbox-testing/standalone.yaml", "../" + baseConfigPath},
		{"sandbox-testing/02-Scenarios/go/standalone.yaml", "../../../" + baseConfigPath},
		{"tele-remote/standalone.yaml", "../" + baseConfigPath},
		{"tele-remote/cmd/tele-remote/standalone.yaml", "../../../" + baseConfigPath},
		{"universal-logger/standalone.yaml", "../" + baseConfigPath},
		{"universal-logger/src/bootstrap/standalone.yaml", "../../../" + baseConfigPath},
		{"universal-logger/unilog/cpp/standalone.yaml", "../../../" + baseConfigPath},
		{"universal-logger/unilog/python/standalone.yaml", "../../../" + baseConfigPath},
		{"universal-logger/unilog/rust/standalone.yaml", "../../../" + baseConfigPath},
		...
		{"docker-deployment/modes/local/inventory.json", "../../../obsidian-brain/05-Fleet-Operation/00-Repo-Control/inventory.json"},
		{"docker-deployment/modes/docker/inventory.json", "../../../obsidian-brain/05-Fleet-Operation/00-Repo-Control/inventory.json"},
		{"docker-deployment/modes/production/inventory.json", "../../../obsidian-brain/05-Fleet-Operation/00-Repo-Control/inventory.json"},
	}
