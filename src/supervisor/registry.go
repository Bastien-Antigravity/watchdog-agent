...
func RegisterServices(rootDir, vectorDBIP, vectorDBPort string, cfg *config.AppConfig) {
	...
	Services = []*Service{
		...
		},
		{
			...
			BuildCmd:  "go",
			BuildArgs: []string{"build", "-o", "bin/config-server", "cmd/config-server/main.go"},
		...
		},
		{
			...
			BuildCmd:  "go",
			BuildArgs: []string{"build", "-o", "bin/notif-server", "cmd/notif-server/main.go"},
		...
		},
		{
			...
			BuildCmd:  "go",
			BuildArgs: []string{"build", "-o", "bin/tele-remote", "cmd/tele-remote/main.go"},
		...
		},
		{
			...
			BuildCmd:  "go",
			BuildArgs: []string{"build", "-o", "bin/web-interface", "cmd/web-interface/main.go"},
